...
class ConditionalRandomFieldBackprop(ConditionalRandomField, nn.Module):
    ...
    def train(self,
        ...
        self._minibatch_size_value = minibatch_size
    ...
    def _zero_grad(self):
        ...
        self._pending_losses: list[TorchScalar] = []
    ...
    def accumulate_logprob_gradient(self, sentence: Sentence, corpus: TaggedCorpus) -> None:
        ...
        norm_loss = loss / max(1, self._minibatch_size_value)
        self._pending_losses.append(norm_loss)
    ...
    def logprob_gradient_step(self, lr: float) -> None:
        ...
        if self._pending_losses:
            total_loss = torch.stack(self._pending_losses).sum()
            total_loss.backward()
